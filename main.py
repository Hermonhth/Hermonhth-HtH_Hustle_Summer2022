...
Chelsea_points = epl_points["Chelsea"]
Liver_pool_points = epl_points["Liver pool"]
Man_city_points = epl_points["Man City"]
Tottenham_points = epl_points["Tottenham"]
...
print(Chelsea_points, Liver_pool_points, Man_city_points, Tottenham_points)
