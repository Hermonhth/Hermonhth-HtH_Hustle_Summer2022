...
message = f"My favorite song from the playlist is {playlist[4]}."
print(message)
...
message4 =f"The song count is {songcount}."
print(message4)
...
# # Break my soul, Freinds, Hrs and Hrs